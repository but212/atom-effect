...
| :--- | :--- | :--- | :--- |
| **SlotBuffer** | push (small) | 339.4K ops/sec | Internal high-performance buffer (x100) |
| **Option** | isSome check | 303.9K ops/sec | Reactive-compatible Option type (x100) |
| **Result** | ok creation | 257.4K ops/sec | Error handling primitive (x100) |
| **Type Guard** | isPromise | 292.9K ops/sec | Fast async primitive detection (x100) |
