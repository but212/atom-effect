...
| :--- | :--- | :--- | :--- |
| **Atom** | Read (untracked) | 5.34M ops/sec | Performance of non-reactive reads (x10) |
| **Computed** | Recompute (cached) | 370.0K ops/sec | Cached re-evaluation performance (x10) |
| **Effect** | Propagation | 1.14M ops/sec | Full atom → computed → effect cycle (x10) |
| **Workflow** | Todo App | 153.2K ops/sec | Comprehensive workflow performance |
| **Latency** | 100 Atom updates | 0.0108 ms | Mean execution time for batched updates |
