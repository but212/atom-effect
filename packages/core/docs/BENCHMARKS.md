...
| ---------- | ---------- | ----- | ------- |
| **Atom** | Read 1000x (peek) | 644K ops/sec | Near-native array access speed |
| **Computed** | Recompute (cached) | 1,693K ops/sec | Cached reads are nearly free |
| **Effect** | Re-runs | 1,065K ops/sec | Efficient change propagation |
| **Real-world** | Todo App (Create 100 items) | 909K ops/sec | Production-ready performance |
...
| ---------- | ------ | -------- |
| Atom peek (1000x) | 644K ops/sec | Near-native performance |
| Computed recompute | 1,693K ops/sec | Cached reads are virtually free |
| Effect re-runs (10x) | 1,065K ops/sec | Efficient propagation |
| Todo App workflow | 225K ops/sec | Production-ready (Complete workflow) |
