...
| ---------- | ---------- | ----- | ------- |
| **Atom** | Read 1000x (peek) | 729K ops/sec | Near-native array access speed |
| **Computed** | Recompute (cached) | 1,778K ops/sec | Cached reads are nearly free |
| **Effect** | Re-runs | 1,191K ops/sec | Efficient change propagation |
| **Real-world** | Todo App (Create 100 items) | 848K ops/sec | Production-ready performance |
...
| ---------- | ------ | -------- |
| Atom peek (1000x) | 729K ops/sec | Near-native performance |
| Computed recompute | 1,778K ops/sec | Cached reads are virtually free |
| Effect re-runs (10x) | 1,191K ops/sec | Efficient propagation |
| Todo App workflow | 201K ops/sec | Production-ready (Complete workflow) |
| Frame Budget (100 atoms) | 0.014ms | Well under 16ms |
| Data Grid Sort (1000 rows) | 0.41ms | Real-time sorting |
