...
| ---------- | ---------- | ----- | ------- |
| **Text Binding** | Update (100el × 50) | 994.7 ops/sec | Direct text node synchronization |
...
| **Todo App** | Full workflow | 24.8K ops/sec | Batch-optimized workflow execution |
| **Dashboard** | Fan-in chain | 2.3K ops/sec | Multi-level propagation chain |
...
| ---------- | ------ | -------- |
| atomText update (100el × 50) | 994.7 ops/sec | Frequency for 5,000 total text node updates |
...
| Todo full workflow | 24.8K ops/sec | Frequency for combined CRUD operations |
| Dashboard fan-in | 2.3K ops/sec | Frequency for multi-level fan-in propagation |
| atomForm O(1) Scaling | 400.3K ops/sec | Validates consistent performance across form sizes |
