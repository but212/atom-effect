...
| ---------- | ---------- | ----- | ------- |
| **Text Binding** | Update (100el × 50) | 194.2 ops/sec | Efficient set-and-notify |
| **Class Binding** | Toggle (100el × 100) | 204.9 ops/sec | Fast optimized toggle |
| **List Render** | 100 items (append) | 136.5 ops/sec | Smooth list updates |
| **Input (DOM→Atom)** | 100 events | 877.6 ops/sec | Minimal event overhead |
| **Todo App** | Full workflow | 1,958.6 ops/sec | High-throughput DOM sync |
| **Dashboard** | Fan-in chain | 1,474.5 ops/sec | Scalable reactive topology |
...
| ---------- | ------ | -------- |
| atomText propagation | 194.2 ops/sec | Consistent DOM text updates |
| atomClass toggle | 204.9 ops/sec | Fast class manipulation |
| atomList render (100) | 136.5 ops/sec | Efficient list reconciliation |
| atomVal DOM→Atom | 877.6 ops/sec | Near-instant input sync |
| Todo full workflow | 1,958.6 ops/sec | Optimized for web-apps |
| Dashboard fan-in | 1,474.5 ops/sec | Efficient computed→DOM chain |
| atomForm O(1) Scaling | 420.2K ops/sec | O(1) field dispatch validated |
