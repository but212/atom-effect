...
| **List Render** | Reconciliation (100 items) | 1.4K ops/sec | Keyed 3-pass reconciliation |
| **Input (DOM→Atom)** | 100 events | 2.0K ops/sec | Direct event-to-atom synchronization |
| **Todo App** | Full workflow | 17.3K ops/sec | Batch-optimized workflow execution |
| **Dashboard** | Fan-in chain | 226.9 ops/sec | Multi-level propagation chain |
...
| atomList reconciliation (100 items) | 1.4K ops/sec | Frequency for 100-item reconciliation cycles |
| atomVal DOM→Atom (100 events) | 2.0K ops/sec | Frequency for 100 sequential input events |
| Todo full workflow | 17.3K ops/sec | Frequency for combined CRUD operations |
| Dashboard fan-in | 226.9 ops/sec | Frequency for multi-level fan-in propagation |
| atomForm O(1) Scaling | 325.6K ops/sec | Validates consistent performance across form sizes |
