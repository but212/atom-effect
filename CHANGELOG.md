...
- **Improved Type Safety**: Restored `computed` function overloads to enforce `defaultValue` for asynchronous computations, preventing runtime errors during pending states.
